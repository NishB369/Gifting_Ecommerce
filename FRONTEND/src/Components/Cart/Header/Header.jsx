...
const Header = () => {
  return (
    <div className="flex justify-between px-12 py-6 bg-white w-full h-[12%] border-b-2 border-b-black/25 fixed top-0 z-10">
        <div><img src='../../public/logo.svg' width={150} className="cursor-pointer"/></div>
